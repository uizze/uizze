...
- GitHub Awesome Copilot external plugin intake: https://github.com/github/awesome-copilot/issues/2690 (immutable `v1.2.11` submission; intake found and is rechecking the root Agent Plugins manifest and bundled reference playbooks)
