...
- Tons of Skills: https://github.com/uizze/uizze/issues/38 (2,600+ star Claude Code marketplace; the public anti-ui-slop Skill gained the required Overview, Prerequisites, Output, Error Handling, and Resources sections, and the domain-backed copy is verified byte-for-byte against this repository; the Path B source was accepted in merged PR #1127, while focused UIZZE mirror repair PR #1242 is mergeable and waiting only on the repository's pre-existing Epic-1 doc-governance drift)
...
- OpenAI Codex curated marketplace: https://github.com/openai/codex/issues/39168 (106,000+ star official Codex repository; issue-based marketplace review request for the canonical UIZZE plugin, free Skill, and no-account preview)
...
- Awesome DevOps MCP Servers: https://github.com/rohitg00/awesome-devops-mcp-servers/pull/316 (1,018-star active MCP directory; adds UIZZE to Continuous Integration as a free-first UI quality gate with the GitHub Action, no-account preview, and accurate optional 800,000+ workflow; PR is mergeable and maintainer review is pending)
...
- TensorBlock MCP Index: https://github.com/TensorBlock/awesome-mcp-servers ([PR #1777](https://github.com/TensorBlock/awesome-mcp-servers/pull/1777) merged and deployed; live profile is https://tensorblock.co/mcp/servers/github-uizze-uizze-2a597cfa with canonical `uizze/uizze` metadata; [metadata issue #1804](https://github.com/TensorBlock/awesome-mcp-servers/issues/1804) requests the free Skill, deterministic preview, and current install/auth details)
...
- Agentic Awesome Skills: https://github.com/sickn33/agentic-awesome-skills/pull/1176 (closed by the maintainer after its provenance gate determined that the historical `aislon/uizze-mcp` → `uizze/uizze` identity transition could not be verified; accepted live UIZZE entry remains PR #1166, and no duplicate repair should be resubmitted without archival evidence)
...
- OpenCode Skills Collection: https://github.com/FrancoStino/opencode-skills-collection/issues/113 (64-star OpenCode plugin with 1,595+ nightly-synced skills; source-update request targets generated UIZZE metadata that still points to retired `aislon/uizze-mcp`; its upstream historical provenance repair was closed, so refresh requires maintainer review of archival evidence)
...
- Awesome Agentic Patterns: https://github.com/nibzard/awesome-agentic-patterns/pull/134 (4,888-star pattern catalogue; contributes a generalized Rendered UI Finish Gate with UIZZE disclosed as one known implementation and the optional 800,000+ workflow kept separate)
- awesome-agentic-ai-zh: https://github.com/WenyuChiou/awesome-agentic-ai-zh/pull/111 (5,300-star trilingual agentic-AI roadmap; proposes the free MIT anti-ui-slop Skill in its Design catalog, with the optional 800,000+ workflow kept separate; maintainer review pending; intake issue: https://github.com/WenyuChiou/awesome-agentic-ai-zh/issues/110)
- Datawhale Hello-Agents: https://github.com/datawhalechina/hello-agents/pull/819 (73,000+ star Chinese agent-building tutorial; adds a practical Extra-Chapter UI quality workflow and README index entry, with the free MIT Skill first and the optional 800,000+ workflow kept separate; maintainer review pending)
...
- VoltAgent Official DESIGN.md: https://github.com/VoltAgent/official-design-md/issues/3 (482-star first-party DESIGN.md tracker; issue-first intake requests the canonical UIZZE design contract)
...
- GitHubDaily: https://github.com/GitHubDaily/GitHubDaily/issues/1030#issuecomment-5324967588 (47,000+ star Chinese developer-discovery repository; recommendation and current verification cover the free Skill, preview MCP, GitHub Action, and accurate 800,000+ distinction)
...
- Organization profile: https://github.com/uizze/.github/blob/main/profile/README.md (PRs #25–#40 merged; profile now surfaces accepted Agentic Awesome Skills, Developer Resources, Agency Agents, and Build with Claude plus the high-reach shortlist and high-signal Codex, frontend system-design, MCP, Agentic Patterns, Chinese Agentic AI, Hello-Agents, GitHubDaily, Wshobson marketplace, catalog-repair, and official Codex marketplace routes)
...
- Domain Skill Install parity: https://github.com/uizze/uizze/actions/runs/32120257733 (passed after app PR #191 and the canonical-copy deployment; the live installer, direct domain Skill, and extracted archive are byte-identical to `skills/anti-ui-slop/SKILL.md` at SHA-256 `1c86da86ae0471af2728433f555816bef2a7600739ac05cf486b4b5355b1b573`; archive digest `46ec08c5ea335d8cc5577c76d1300c126cc2d8b10d1c80bc6cca58a5259d1e14`)
...
- Agentic Patterns contribution PR: https://github.com/nibzard/awesome-agentic-patterns/pull/134 (pattern-first Rendered UI Finish Gate contribution; local Python validation reports zero issues, while the upstream Claude review and Vercel preview contexts are externally blocked)
...
- GitHubDaily recommendation issue: https://github.com/GitHubDaily/GitHubDaily/issues/1030#issuecomment-5324967588 (Chinese-language project recommendation with official source, MIT license, free install path, and separate preview/full-product scope)
...
- Agentic Awesome Skills PR: https://github.com/sickn33/agentic-awesome-skills/pull/1166 (merged; the live directory entry exists; separate historical source repair PR #1176 was closed because the provenance transition could not be verified)
...
- VoltAgent Official DESIGN.md request: https://github.com/VoltAgent/official-design-md/issues/3 (first-party UIZZE DESIGN.md request; the public artifact is maintained in the canonical repository)
...
- Tons of Skills external source: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/pull/1242 (focused repair for the accepted Path B source in #1127; the UIZZE mirror is complete and all UIZZE/mirror gates pass, while the merge is waiting only on pre-existing Epic-1 doc-governance drift in the upstream repository)
...
- Agentic Awesome Skills: https://github.com/sickn33/agentic-awesome-skills/pull/1166 (merged; live entry); historical source metadata repair PR #1176 was closed by the maintainer and should not be retried without archival provenance evidence
...
- OpenCode Skills Collection: https://github.com/FrancoStino/opencode-skills-collection/issues/113 (downstream source-update intake; its generated bundle follows `sickn33/agentic-awesome-skills` and remains pending the maintainer-reviewed archival provenance needed for a historical source change)
...
- ToolSDK MCP Registry: https://github.com/toolsdk-ai/toolsdk-mcp-registry/pull/398 (merged structured MCP registry entry); source repair PR #460 now replaces the retired repository URL with canonical `uizze/uizze`, points at the free no-account preview, and passes full-registry validation plus Biome checks; maintainer review pending)
- Wundercorp Awesome MCP: https://github.com/wundercorp/awesome-mcp/pull/48 (repairs the existing 19-star design-directory entry and generated README to use canonical `uizze/uizze`, the free no-account preview, and the `check_ui_slop` tool; catalog validation passes and maintainer review is pending)
...
- Best of AI Directories: https://github.com/best-of-ai/ai-directories/pull/389 (864-star AI directory index; adds UIZZE in the U section with product and canonical GitHub links, the free Skill, and accurate optional 800,000+ screen scope; one-line diff)
- 0voice Awesome AI Tools: https://github.com/0voice/awesome-ai-tools/pull/119 (422-star Chinese AI-tools index; adds a localized UIZZE row to UI/UX design tools with the free MIT Skill, no-account deterministic preview, and accurate optional 800,000+ real-screen workflow)
- Awesome MCP DevTools: https://github.com/punkpeye/awesome-mcp-devtools/pull/283 (477-star active MCP developer-tools directory; adds UIZZE under Development Tools with the free Skill, deterministic preview, and separated optional 800,000+ workflow)
- Codesandtags Frontend Resources: https://github.com/codesandtags/frontend-resources/pull/34 (195-star active frontend resource index; adds UIZZE through its JSON source and generated Design Systems & UI/UX section with the free MIT Skill and separated optional 800,000+ workflow)
