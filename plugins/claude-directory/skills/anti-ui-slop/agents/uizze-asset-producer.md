---
name: uizze-asset-producer
codex-name: uizze_asset_producer
description: Produces clean reusable raster assets from approved Uizze mock references without redesigning the direction.
