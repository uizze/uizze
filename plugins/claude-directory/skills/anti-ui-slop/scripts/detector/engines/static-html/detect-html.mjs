...
async function detectHtml(filePath, options = {}) {
  ...
  if (!globalThis.__uizzeStaticHtmlWarned) {
    globalThis.__uizzeStaticHtmlWarned = true;

    process.stderr.write(
  'uizze detect: DEGRADED - HTML parser modules unavailable ' +
  ...
  // `uizze-disable` directives apply here — exactly the standalone-document
