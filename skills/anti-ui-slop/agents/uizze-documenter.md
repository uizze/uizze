---
name: uizze-documenter
codex-name: uizze_documenter
description: Records DESIGN.md and its sidecar from a finished Uizze build, deriving the design system from the shipped artifact rather than from intentions.
