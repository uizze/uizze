...
Options:
  ...
  --no-inline-ignores Do not honor in-file uizze-disable* ignore comments
  --no-design-system  Do not load local DESIGN.md / .uizze/design.json context
...
Project config:
  Respects .uizze/config.json and .uizze/config.local.json detector
  settings: detector.ignoreRules, detector.ignoreFiles, detector.ignoreValues,
  and detector.designSystem.enabled.

Inline ignores:
  In-file comments waive a finding where it lives and travel with the file:
    <!-- uizze-disable overused-font -- exported brand doc -->
    .brand { font-family: Inter } /* uizze-disable-line overused-font */
    // uizze-disable-next-line bounce-easing: intentional bounce
  uizze-disable applies to the whole file; -line / -next-line are scoped.
...
async function detectCli() {
  ...
  // Inline `uizze-disable*` waivers are part of the scanned file, so they
